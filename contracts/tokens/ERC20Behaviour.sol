...
contract ERC20Behaviour is Owned, Proxyable {
     ...
     */
    function setTokenState(ERC20State _tokenState) external optionalProxy_onlyOwner {
        tokenState = _tokenState;
